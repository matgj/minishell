...
SRCS =	main.c exit.c parsing.c parsing2.c parsing3.c parsing4.c parsing5.c parsing6.c environment.c command.c \
		...
		builtins/ft_echo.c builtins/ft_pwd.c builtins/ft_env.c builtins/ft_cd.c builtins/ft_export.c builtins/ft_unset.c \
		builtins/utils/ft_memset.c builtins/export/ft_export_utils_0.c builtins/export/ft_export_utils_1.c builtins/export/ft_export_ancien.c builtins/utils/ft_putendl_fd.c builtins/utils/ft_putstr_fd.c builtins/ft_exit.c
