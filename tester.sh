...
#    Updated: 2020/11/02 17:26:14 by Mathis           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
test "cat|cat|ls"
test "ls|cat -e"
test "ls < test1 < test > test4 | cat -e > test 1;echo \$? | cat -e       | cat -e|cat -e; rm gsdfgsd | echo 4 | exit 7412398461293784612983746128973468927 | cat -e | dsf | exit;"
test "ls | cat"
test "cat | ls -l"
test "       \n              "
test "badcmd\n\n\n\necho \$?"
